...
import { increaseQuantityProductInCart, decreaseQuantityProductInCart } from "../controllers/carts.controller.js";
...
viewsRouter.get("/:cid/delete/",  applyPolicies(['USER', 'PREMIUM']), deleteCart);
